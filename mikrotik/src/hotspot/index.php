...
<html lang="en">
  ...
  <body role="document">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <?php 
            switch($task){
              case 0: hotspotServer($_SESSION["id_hotel"]);
                      break;
              case 1: hotspotUser($_SESSION["id_hotel"]);
                      editarUserHotspot();
                      break;
    ...
    $(document).ready(function(){
      $("button[name=activar]").click(function(){
        $.ajax({
          url: "enableUser.php",
          type: "post",
          data: "idU="+ $(this).val() + "&en=true",
      ...
      $("button[name=desactivar]").click(function(){
        $.ajax({
          url: "enableUser.php",
          type: "post",
          data: "idU="+ $(this).val() + "&dis=true",
          success: function(datos){            
              if(datos == "ok"){
                var url = $(location).attr('href');              
                $(location).attr('href',url);
